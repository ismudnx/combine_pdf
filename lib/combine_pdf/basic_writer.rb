...
module CombinePDF
  ...
  #
  # We can either insert the PDFWriter as a new :page=>  #   pdf = CombinePDF.new
  #   new_page = CombinePDF.create_page # => PDFWriter object
  #   new_page.textbox "some text"
  #   pdf << new_page
  #   pdf.save "file_with_new_page.pdf"
  #
  # Or we can use the Page_Methods methods to write an overlay (stamp / watermark) over existing :pages=>  #   pdf = CombinePDF.new
